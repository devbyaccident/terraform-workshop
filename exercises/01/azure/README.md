...
```bash
cd workshop/exercises/01/azure
```
...
```HCL
# Declare the provider being used, in this case it's Azure.
# This provider supports setting the provider version, Azure credentials as well as the region.
